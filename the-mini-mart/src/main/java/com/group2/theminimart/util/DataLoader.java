...
public class DataLoader {
        ...
        public void loadData() {
                ...
                UserRegisterRequestDto.builder().username("firhat").password("12345678").build());
                ...
                // CREATE CART
                // CartContent cart1 =
                cartContentRepository.save(CartContent.builder().product(product1).user(firhat).count(1).total(109.95)
                                .build());
